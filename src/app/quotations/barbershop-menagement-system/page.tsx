...
export default function BarbershopQuotation() {
  const packages = [
    {
      name: "PAKET BASIC",
      price: "Rp 2.500.000",
      ...
      description: "Cocok untuk barbershop pemula",
      features: [
        { name: "Kelola Data Pelanggan", included: true, icon: Users },
        { name: "Transaksi Layanan", included: true, icon: Scissors },
        { name: "Cetak Struk", included: true, icon: Wallet },
        { name: "Laporan Penjualan Harian", included: true, icon: TrendingUp },
        { name: "Sistem Booking/Antrian", included: false, icon: Calendar },
        { name: "Manajemen Produk & Stok", included: false, icon: Package },
        { name: "Kelola Barber/Staff", included: false, icon: Users },
        { name: "Laporan Keuangan Lengkap", included: false, icon: Wallet },
        { name: "Membership & Loyalty", included: false, icon: Users },
        { name: "Dashboard Analitik", included: false, icon: TrendingUp },
      ],
    },
    {
      name: "PAKET STANDARD",
      ...
      description: "Pilihan terbaik untuk barbershop berkembang",
      popular: true,
      features: [
        { name: "Kelola Data Pelanggan", included: true, icon: Users },
        { name: "Transaksi Layanan", included: true, icon: Scissors },
        { name: "Cetak Struk", included: true, icon: Wallet },
        { name: "Laporan Penjualan Harian", included: true, icon: TrendingUp },
        { name: "Sistem Booking/Antrian", included: true, icon: Calendar },
        { name: "Manajemen Produk & Stok", included: true, icon: Package },
        { name: "Kelola Barber/Staff", included: true, icon: Users },
        { name: "Laporan Keuangan Lengkap", included: true, icon: Wallet },
        { name: "Membership & Loyalty", included: false, icon: Users },
        { name: "Dashboard Analitik", included: false, icon: TrendingUp },
      ],
    },
    {
      ...
      description: "Solusi lengkap untuk barbershop profesional",
      features: [
        { name: "Kelola Data Pelanggan", included: true, icon: Users },
        { name: "Transaksi Layanan", included: true, icon: Scissors },
        { name: "Cetak Struk", included: true, icon: Wallet },
        ...
        { name: "Kelola Barber/Staff", included: true, icon: Users },
        { name: "Laporan Keuangan Lengkap", included: true, icon: Wallet },
        { name: "Membership & Loyalty", included: true, icon: Users },
        { name: "Dashboard Analitik", included: true, icon: TrendingUp },
      ],
    },
  ];
  ...
  const detailFeatures = [
    ...
    {
      title: "Sistem Booking/Antrian",
      items: [
        "Booking online via web",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-bold mb-3">
            System Management Barbershop
          </h2>
          <p className="text-slate-300 text-lg">
            Solusi digital untuk mengelola barbershop Anda secara profesional
          </p>
        </div>
        ...
        <div className="bg-slate-800/50 backdrop-blur border-2 border-slate-700 rounded-2xl p-8 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-slate-900/50 rounded-xl p-6 border border-slate-700">
              ...
              <h4 className="font-bold mb-3 text-purple-400">Booking Online</h4>
              <p className="text-slate-300 text-sm">
                Pelanggan bisa booking lewat web, pilih barber favorit & jadwal
                yang sesuai. Sistem otomatis kelola antrian.
              </p>
            </div>
            <div className="bg-slate-900/50 rounded-xl p-6 border border-slate-700">
              ...
              <p className="text-slate-300 text-sm">
                Program loyalitas dengan poin reward, diskon member, dan paket
                berlangganan untuk pelanggan setia.
              </p>
            </div>
            <div className="bg-slate-900/50 rounded-xl p-6 border border-slate-700">
              <TrendingUp className="w-10 h-10 text-amber-400 mb-4" />
              <h4 className="font-bold mb-3 text-amber-400">Komisi Barber</h4>
              <p className="text-slate-300 text-sm">
                Tracking otomatis komisi per barber, laporan performa, dan
                target penjualan untuk motivasi tim.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-300">
                ...
                <li>• Paket Premium: 4-5 minggu</li>
              </ul>
